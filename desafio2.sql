-- 2. Com base em todos os cargos presentes, queremos categorizar o nível de remuneração de cada cargo. Utilizando o banco hr como referência, seu relatório deve possuir as seguintes colunas:
