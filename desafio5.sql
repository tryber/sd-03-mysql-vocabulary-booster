...
WHERE jobs.JOB_ID = employees.JOB_ID group by Cargo
ORDER BY (MAX_SALARY - MIN_SALARY ) ASC, Cargo, hr.jobs.MAX_SALARY, hr.jobs.MIN_SALARY,'Média mínima mensal', 'Média máxima mensal' ;
